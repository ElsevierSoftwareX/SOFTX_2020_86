...
#define INTEL_PREFERRED 0x8086
#define ARM_MALI_PREFERRED 0x13B5
#define QUALCOMM_PREFERRED 0x5143
#define IMG_TECH_PREFERRED 0x1010

#define NO_VENDOR_PREFERRED 0

#define DEV_SELECT_FIRST 1  
#define DEV_SELECT_SECOND 2
#define DEV_SELECT_THIRD 3
#define DEV_SELECT_FOURTH 4
